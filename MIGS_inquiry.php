...
$num_mem=0;
$sql_mem = pg_query($db, "SELECT a.*,(SELECT organization FROM organizations where organization_id=members_ou_code
) as pt_no FROM members a left join members_standing_scores b on a.sc_acctno=b.sc_acctno WHERE  a.sc_acctno='$sc_acctno' and  birthdate='$birthdate';") or die ("Could not match data because ".pg_last_error());
