...
<?php
   ...
   function RemoveSpecialChar($str) {
    ...
    $sql = pg_query($db, "
    select * from election_user where sc_acctno not in ( select sc_acctno from election_voted);
...
<div class="container-fluid">
 ...
 <br>
 <h5 class="text-center"><?php echo '( '.number_format($novote).' ) '; ?>No Votes As of <?php echo date('F j, Y h:i:s A');//echo date('F j, Y h:i:s A'); ?></h5>
