...
,concat(last_name,',',first_name,' ',middle_name) as fullname,a.sc_acctno as acctno FROM jar_coop_member a left join members_standing_scores b on a.sc_acctno=b.sc_acctno WHERE a.sc_acctno='$_POST[acctno]';") or die ("Could not match data because ".pg_last_error());
