...
$(document).ready(function(){
  ...
  $('#submit_vote').click(function(){
    ...
    if (d1Checked != $('#d1pos').val()) {
      $("#error_d1").html("<div class='alert alert-danger'><b>does not match the required vote </b></div>");
      $('#error_d1').focus();
    }
    else
      $("#error_d1").html("");
...
?>
  ...
  if ($row_pos['max_selection']> 1)
   echo "<i>(Required votes -  $row_pos[max_selection])</i>"; 
  else 
   echo "<i>(Required vote -  $row_pos[max_selection])</i>"; 
  ?>
  </b>
